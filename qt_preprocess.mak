...
compilers: qrc_resources.qrc12.cpp moc_predefs.h moc_bubblesorter.cpp moc_graphicsview.cpp moc_mainwindow.cpp\
	 moc_painterpalette.cpp moc_sorter.cpp moc_qtmaterialappbar.cpp\
	 moc_qtmaterialautocomplete.cpp moc_qtmaterialautocomplete_internal.cpp moc_qtmaterialavatar.cpp\
	 moc_qtmaterialbadge.cpp moc_qtmaterialcheckbox.cpp moc_qtmaterialcircularprogress.cpp\
	 moc_qtmaterialcircularprogress_internal.cpp moc_qtmaterialdialog.cpp moc_qtmaterialdialog_internal.cpp\
	 moc_qtmaterialdrawer.cpp moc_qtmaterialdrawer_internal.cpp moc_qtmaterialfab.cpp\
	 moc_qtmaterialflatbutton.cpp moc_qtmaterialflatbutton_internal.cpp moc_qtmaterialiconbutton.cpp\
	 moc_qtmaterialmenu.cpp moc_qtmaterialprogress.cpp moc_qtmaterialprogress_internal.cpp\
	 moc_qtmaterialradiobutton.cpp moc_qtmaterialraisedbutton.cpp moc_qtmaterialscrollbar.cpp\
	 moc_qtmaterialscrollbar_internal.cpp moc_qtmaterialslider.cpp moc_qtmaterialslider_internal.cpp\
	 moc_qtmaterialsnackbar.cpp moc_qtmaterialsnackbar_internal.cpp moc_qtmaterialtabs.cpp\
	 moc_qtmaterialtabs_internal.cpp moc_qtmaterialtextfield.cpp moc_qtmaterialtextfield_internal.cpp\
	 moc_qtmaterialtoggle.cpp moc_qtmaterialtoggle_internal.cpp moc_qtmaterialcheckable.cpp\
	 moc_qtmaterialcheckable_internal.cpp moc_qtmaterialoverlaywidget.cpp moc_qtmaterialripple.cpp\
	 moc_qtmaterialrippleoverlay.cpp moc_qtmaterialstatetransition.cpp moc_qtmaterialstyle.cpp\
	 moc_qtmaterialtheme.cpp
compiler_rcc_make_all: qrc_resources.qrc12.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_resources.qrc12.cpp
qrc_resources.qrc12.cpp: components/resources.qrc12.qrc \
		/usr/local/Cellar/qt/5.9.1/bin/rcc
	/usr/local/Cellar/qt/5.9.1/bin/rcc -name resources.qrc12 components/resources.qrc12.qrc -o qrc_resources.qrc12.cpp
